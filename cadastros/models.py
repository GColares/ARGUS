...
class Convenio(InstrumentoJuridicoBase):
    ...
    projeto = models.ForeignKey('ProjetoPDI', on_delete=models.CASCADE, related_name='convenios', null=True, blank=True, verbose_name="Projeto Mestre")
...
class PlanoDeTrabalho(models.Model):
    ...
    termo_homologador = models.ForeignKey(InstrumentoJuridicoBase, on_delete=models.SET_NULL, null=True, blank=True, related_name='planos_homologados', verbose_name="Termo Homologador")
...
class TermoCooperacao(InstrumentoJuridicoBase):
    """
...
class ProjetoPDI(models.Model):
    ...
    def termo_parceria(self):
        """Alias para retrocompatibilidade com templates que buscam o instrumento principal do projeto."""
...
class TermoAditivo(models.Model):
    ...
    instrumento = models.ForeignKey(InstrumentoJuridicoBase, on_delete=models.CASCADE, related_name='aditivos', null=True, blank=True)
