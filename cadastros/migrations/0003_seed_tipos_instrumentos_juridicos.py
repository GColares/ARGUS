...
def populate_tipos(apps, schema_editor):
    ...
    tipos = [
        ...
        {"nome": "Convênio de PD&I", "sigla": "CONV", "descricao": "Projetos legados executados antes da adoção de Acordos de Parceria."},
        {"nome": "Acordo de Parceria", "sigla": "AP", "descricao": "Novo modelo de parceria baseado no Marco Legal de CT&I."},
