...
- dono exclusivo do repositório: o **Cursor** também implementa. Três IAs no
  mesmo arquivo = regressão certa.

O usuário pode inverter os papéis numa tarefa. Se ele disser “ Copilot só
revisa” ou “Cursor implementa”, obedeça e declare isso no diário.
...
Se o Cursor ou o Gemini declarou posse desses arquivos nesta sessão, **não
...
```
## [AAAA-MM-DD] Handoff Copilot → (Gemini|Cursor)
...
Definida com o usuário + Cursor. Copilot só entra numa onda se o arquivo
estiver livre.
